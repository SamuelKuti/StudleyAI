    ...
    <section className="mx-10 my-[60px] md:mx-32">
      <div className="bg-peachBg rounded-3xl p-8 md:p-16">
        <div className="container mx-auto flex flex-col items-center justify-between gap-5">
          ...
          <button className="bg-primary text-white px-5 py-2.5 shadow-[3px_3px_0_#000] hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none transition-all md:w-[200px] w-1/2 md:w-auto">
